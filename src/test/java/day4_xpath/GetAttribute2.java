...
public class GetAttribute2 {
        /*
        go to https://practice .cybertekschool.com/dynamic_loading
        locate : Example 1: Element on page that is hidden and become visible
    ...
    public static void main(String[] args) {
        ...
        driver.get("http://practice.cybertekschool.com/dynamic_loding");
